<?php
    ...
    // query
    $sql_category = 'SELECT category, icon_img, action FROM rt1_category';
    $sql_itmes = 'SELECT category, label, icon_img FROM menu_items';

    // execute query
    $categories_result = mysqli_query($connection, $sql_category);
    $items_result = mysqli_query($connection, $sql_itmes);
